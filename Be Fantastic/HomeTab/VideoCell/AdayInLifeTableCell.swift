...
class AdayInLifeTableCell: UITableViewCell {
...
//
//}
extension AdayInLifeTableCell:UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "AdayInLifeCollectionCell", for: indexPath as IndexPath) as! AdayInLifeCollectionCell
