...
open class UPCarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    fileprivate func updateLayout() {
        ...
        let xInset = (collectionSize.width - self.itemSize.width) / 1
        
        print("XInset 24 \(xInset) and YInset \(yInset)")
        self.sectionInset = UIEdgeInsets.init(top: yInset, left: 15, bottom: yInset, right: xInset)
